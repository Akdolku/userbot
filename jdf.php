...
/*	F	*/
function jdate($format,$timestamp='',$none='',$time_zone='Asia/Tashkent',$tr_num='fa'){

 $T_sec=0;/* <= رفع خطاي زمان سرور ، با اعداد '+' و '-' بر حسب ثانيه */

 if($time_zone!='local')date_default_timezone_set(($time_zone==='')?'Asia/Tashkent':$time_zone);
...
/*	F	*/
function jstrftime($format,$timestamp='',$none='',$time_zone='Asia/Tashkent',$tr_num='fa'){
...
/*	F	*/
function jmktime($h='',$m='',$s='',$jm='',$jd='',$jy='',$none='',$timezone='Asia/Tashkent'){
...
/*	F	*/
function jgetdate($timestamp='',$none='',$timezone='Asia/Tashkent',$tn='en'){
